MdotApp::Application.configure do
  ...
  config.assets.precompile += ['sites_manifest.css', 'sites_manifest.js', 'mod_manifest.css', 'mod_manifest.js' ]
  ...
  config.action_mailer.default_url_options = { :host => 'mbilify.com' }
  # ActionMailer Config
